...
class NewMessageSignalHandler {
    ...
    public void notify(int notificationId, StatusChat chat) {
        Log.e(TAG, "==============NOTIFICATIONID===========================" + Integer.toString(notificationId) + chat.getName());
        NotificationCompat.MessagingStyle messagingStyle = new NotificationCompat.MessagingStyle("Me");
        // .setConversationTitle(chat.getName());
    ...
    private Person getPerson(String publicKey, String icon, String name) {
        ...
        Person person = (Person) persons.get(publicKey);
        if (person == null) {
    ...
    private void upsertChat(JSONObject chatNewMessagesData) {
        try {
            ...
            Log.e(TAG, "+================================================================================");
            Log.e(TAG, chatData.toString());
            // one to one chat
            if (oneToOne) {
                Log.e(TAG, "+================================================================================");
                Log.e(TAG, chatNewMessagesData.toString());
...
class StatusChat {
    ...
    public String getName() {
        ...
        Log.e("StatusModule", "GETNAME: " + getLastMessage());
